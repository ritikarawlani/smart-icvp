RuleSet: Question(linkId, text, type, repeats, required)
* item[+].linkId = "{linkId}"
* item[=].text = "{text}"
* item[=].type = #{type}
...
* insert Question(nid, National Identification Document, false, false)
* insert Question(guardian, Name of Parent or Guardian, false, false)
